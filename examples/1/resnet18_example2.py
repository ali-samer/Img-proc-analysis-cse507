...
# Data loaders with increased workers for faster data loading
loaders = {
    'train': DataLoader(train_data, batch_size=512, shuffle=True, num_workers=4, pin_memory=True),
    'test': DataLoader(test_data, batch_size=512, shuffle=False, num_workers=4, pin_memory=True),
}
...
def save_metrics():
    ...
    metrics_df.to_csv('resnet18_model_metrics_detailed.csv', index=False)
    print("Metrics saved to 'resnet18_model_metrics_detailed.csv'")
